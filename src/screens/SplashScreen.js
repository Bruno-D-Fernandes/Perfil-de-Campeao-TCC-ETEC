  ...
  return (
    ...
    <View className="flex-1 justify-end items-end h-full flex-col items-center">
      ...
      <View className="w-full h-[350px] justify-end items-center">
        ...
        <Pressable className="mt-8 mb-8 w-[80%] rounded-[40px] h-[50px] bg-white flex-row items-center justify-between" onPress={() => navigation.replace('AuthStack', { screen: 'Login' })}>
