  ...
  return (
    <View style={tw`mb-8`}>
      ...
      <View style={tw`w-full`}>
        <Text style={[tw`text-[#4ADC76] text-sm mb-2`, {fontFamily:'Poppins_500Medium'}]}>E-mail</Text>
        <View style={tw`flex-row items-center rounded-xl h-12 border-[#4ADC76] border-2`}>
          ...
          />
          <TextInput
            style={[tw`flex-1 h-full text-sm`, {fontFamily:'Poppins_500Medium'}]}
            placeholder="E-mail"
      ...
      <View style={tw`w-full mt-4`}>
        <Text style={[tw`text-[#4ADC76] text-sm mb-2`, {fontFamily:'Poppins_500Medium'}]}>Senha</Text>
        <View style={tw`flex-row items-center rounded-xl h-12 border-[#4ADC76] border-2`}>
          <Image
